...
const {
    ...
    satisfyRuntimeCode
} = require('webpack/lib/util/semver')
...
class ConsumeSharedRuntimeModule extends RuntimeModule {
    ...
    generate() {
        ...
        return Template.asString([
            ...
            `var findLatestVersion = ${runtimeTemplate.basicFunction('scope, key, eager', [
            ...
            `var findSingletonVersionKey = ${runtimeTemplate.basicFunction('scope, key, eager', [
                'var versions = eager ? eagerOnly(scope[key]) : scope[key];',
                `return Object.keys(versions).reduce(${runtimeTemplate.basicFunction(
                    'a, b',
            ...
            '',
            `var useFallback = ${runtimeTemplate.basicFunction('scopeName, key, fallback', [

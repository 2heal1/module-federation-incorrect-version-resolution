 ...
 * Modified by Kirill Zaytsev zaytsev.cmath10@gmail.com
 */
...
const { parseRange } = require('webpack/lib/util/semver')
const ConsumeSharedFallbackDependency = require('webpack/lib/sharing/ConsumeSharedFallbackDependency')
const ConsumeSharedModule = require('./ConsumeSharedModule')
const ConsumeSharedRuntimeModule = require('./ConsumeSharedRuntimeModule')
const ProvideForSharedDependency = require('webpack/lib/sharing/ProvideForSharedDependency')
const { resolveMatchedConfigs } = require('webpack/lib/sharing/resolveMatchedConfigs')

const {
    isRequiredVersion,
    getDescriptionFile,
    getRequiredVersionFromDescriptionFile
} = require('webpack/lib/sharing/utils')
...
/** @typedef {import('webpack/lib/sharing/ConsumeSharedModule').ConsumeOptions} ConsumeOptions */
        ...
        this._consumes = parseOptions(
            ...
            (item, key) => {
                ...
                return item === key || !isRequiredVersion(item)
                    ...
                    : { // key is a request/key, item is a version
                        import: key,
                        shareScope: options.shareScope || 'default',
                        shareKey: key,
